...
function (_CloudinaryComponent) {
  _inherits(PictureSource, _CloudinaryComponent);

  function PictureSource(props, context) {
    var _this;

    _classCallCheck(this, PictureSource);
    ...
    _this = _possibleConstructorReturn(this, _getPrototypeOf(PictureSource).call(this, props, context));
  ...
  _createClass(PictureSource, [{
    ...
    value: function render() {
      ...
      return _react["default"].createElement("source", _extends({}, attributes, {
